"""Fixture-driven tests for infrastructure change control.
...
from examples.infrastructure.policy import InfrastructureChangePolicy
...
def test_fixture_reaches_its_stated_outcome(case):
    run_case(InfrastructureChangePolicy(), case)
